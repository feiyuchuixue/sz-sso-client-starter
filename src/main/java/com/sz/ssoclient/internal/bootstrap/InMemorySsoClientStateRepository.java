...
/** 仅允许 local、dev、test 使用的单进程原子状态仓储。 */
public final class InMemorySsoClientStateRepository implements SsoClientStateRepository {

    private final ConcurrentHashMap<String, Entry> entries = new ConcurrentHashMap<>();
    private final Clock clock;

    public InMemorySsoClientStateRepository(Clock clock) {
