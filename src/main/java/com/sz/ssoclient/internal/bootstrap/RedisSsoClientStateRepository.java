...
/** 基于 Spring Data Redis 的共享原子安全状态仓储。 */
public final class RedisSsoClientStateRepository implements SsoClientStateRepository {
    ...
    public RedisSsoClientStateRepository(StringRedisTemplate redis) {
    ...
    public boolean compareAndSet(
        ...
        Long result = redis.execute(
                COMPARE_AND_SET,
                List.of(required(key)),
                required(expectedValue),
                required(newValue),
                Long.toString(positive(ttl).toMillis()));
